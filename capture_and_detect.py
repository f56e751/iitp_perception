"""Local RealSense capture + SAM detection, save JSONL + serve MJPEG stream.

Replaces the network round-trip in communication.py: instead of receiving
images from a remote robot PC, the camera is plugged directly into this
machine and frames are grabbed via pyrealsense2.
